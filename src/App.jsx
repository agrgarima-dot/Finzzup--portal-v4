...
const I = ({ n, s=14, c="currentColor" }) => {
  const W=s,H=s,V="0 0 24 24",F="none",SW="1.75",SL="round";
  if (n==="home") return <svg width={W} height={H} viewBox={V} fill={F} stroke={c} strokeWidth={SW} strokeLinecap={SL} strokeLinejoin={SL} style={{display:"inline-block",verticalAlign:"middle",flexShrink:0}}><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>;
  if (n==="dashboard") return <svg width={W} height={H} viewBox={V} fill={F} stroke={c} strokeWidth={SW} strokeLinecap={SL} strokeLinejoin={SL} style={{display:"inline-block",verticalAlign:"middle",flexShrink:0}}><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg>;
  if (n==="cashflow") return <svg width={W} height={H} viewBox={V} fill={F} stroke={c} strokeWidth={SW} strokeLinecap={SL} strokeLinejoin={SL} style={{display:"inline-block",verticalAlign:"middle",flexShrink:0}}><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg>;
  if (n==="treasury") return <svg width={W} height={H} viewBox={V} fill={F} stroke={c} strokeWidth={SW} strokeLinecap={SL} strokeLinejoin={SL} style={{display:"inline-block",verticalAlign:"middle",flexShrink:0}}><rect x="2" y="5" width="20" height="14" rx="2"/><line x1="2" y1="10" x2="22" y2="10"/></svg>;
  if (n==="actions") return <svg width={W} height={H} viewBox={V} fill={F} stroke={c} strokeWidth={SW} strokeLinecap={SL} strokeLinejoin={SL} style={{display:"inline-block",verticalAlign:"middle",flexShrink:0}}><polyline points="9 11 12 14 22 4"/><path d="M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11"/></svg>;
  if (n==="report") return <svg width={W} height={H} viewBox={V} fill={F} stroke={c} strokeWidth={SW} strokeLinecap={SL} strokeLinejoin={SL} style={{display:"inline-block",verticalAlign:"middle",flexShrink:0}}><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>;
  if (n==="tax") return <svg width={W} height={H} viewBox={V} fill={F} stroke={c} strokeWidth={SW} strokeLinecap={SL} strokeLinejoin={SL} style={{display:"inline-block",verticalAlign:"middle",flexShrink:0}}><path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M2 12l10 5 10-5"/></svg>;
  if (n==="compliance") return <svg width={W} height={H} viewBox={V} fill={F} stroke={c} strokeWidth={SW} strokeLinecap={SL} strokeLinejoin={SL} style={{display:"inline-block",verticalAlign:"middle",flexShrink:0}}><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>;
  if (n==="audit") return <svg width={W} height={H} viewBox={V} fill={F} stroke={c} strokeWidth={SW} strokeLinecap={SL} strokeLinejoin={SL} style={{display:"inline-block",verticalAlign:"middle",flexShrink:0}}><path d="M9 11l3 3L22 4"/><path d="M21 12v7a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h11"/></svg>;
  if (n==="market") return <svg width={W} height={H} viewBox={V} fill={F} stroke={c} strokeWidth={SW} strokeLinecap={SL} strokeLinejoin={SL} style={{display:"inline-block",verticalAlign:"middle",flexShrink:0}}><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 014 10 15.3 15.3 0 01-4 10 15.3 15.3 0 01-4-10 15.3 15.3 0 014-10z"/></svg>;
  if (n==="calendar") return <svg width={W} height={H} viewBox={V} fill={F} stroke={c} strokeWidth={SW} strokeLinecap={SL} strokeLinejoin={SL} style={{display:"inline-block",verticalAlign:"middle",flexShrink:0}}><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>;
  if (n==="request") return <svg width={W} height={H} viewBox={V} fill={F} stroke={c} strokeWidth={SW} strokeLinecap={SL} strokeLinejoin={SL} style={{display:"inline-block",verticalAlign:"middle",flexShrink:0}}><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="16"/><line x1="8" y1="12" x2="16" y2="12"/></svg>;
  if (n==="documents") return <svg width={W} height={H} viewBox={V} fill={F} stroke={c} strokeWidth={SW} strokeLinecap={SL} strokeLinejoin={SL} style={{display:"inline-block",verticalAlign:"middle",flexShrink:0}}><path d="M22 19a2 2 0 01-2 2H4a2 2 0 01-2-2V5a2 2 0 012-2h5l2 3h9a2 2 0 012 2z"/></svg>;
  if (n==="invoices") return <svg width={W} height={H} viewBox={V} fill={F} stroke={c} strokeWidth={SW} strokeLinecap={SL} strokeLinejoin={SL} style={{display:"inline-block",verticalAlign:"middle",flexShrink:0}}><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>;
  if (n==="engagement") return <svg width={W} height={H} viewBox={V} fill={F} stroke={c} strokeWidth={SW} strokeLinecap={SL} strokeLinejoin={SL} style={{display:"inline-block",verticalAlign:"middle",flexShrink:0}}><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>;
  if (n==="bell") return <svg width={W} height={H} viewBox={V} fill={F} stroke={c} strokeWidth={SW} strokeLinecap={SL} strokeLinejoin={SL} style={{display:"inline-block",verticalAlign:"middle",flexShrink:0}}><path d="M18 8A6 6 0 006 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 01-3.46 0"/></svg>;
  if (n==="logout") return <svg width={W} height={H} viewBox={V} fill={F} stroke={c} strokeWidth={SW} strokeLinecap={SL} strokeLinejoin={SL} style={{display:"inline-block",verticalAlign:"middle",flexShrink:0}}><path d="M9 21H5a2 2 0 01-2-2V5a2 2 0 012-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/></svg>;
  if (n==="check") return <svg width={W} height={H} viewBox={V} fill={F} stroke={c} strokeWidth={SW} strokeLinecap={SL} strokeLinejoin={SL} style={{display:"inline-block",verticalAlign:"middle",flexShrink:0}}><polyline points="20 6 9 17 4 12"/></svg>;
  if (n==="alert") return <svg width={W} height={H} viewBox={V} fill={F} stroke={c} strokeWidth={SW} strokeLinecap={SL} strokeLinejoin={SL} style={{display:"inline-block",verticalAlign:"middle",flexShrink:0}}><path d="M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>;
  if (n==="info") return <svg width={W} height={H} viewBox={V} fill={F} stroke={c} strokeWidth={SW} strokeLinecap={SL} strokeLinejoin={SL} style={{display:"inline-block",verticalAlign:"middle",flexShrink:0}}><circle cx="12" cy="12" r="10"/><line x1="12" y1="16" x2="12" y2="12"/><line x1="12" y1="8" x2="12.01" y2="8"/></svg>;
  if (n==="download") return <svg width={W} height={H} viewBox={V} fill={F} stroke={c} strokeWidth={SW} strokeLinecap={SL} strokeLinejoin={SL} style={{display:"inline-block",verticalAlign:"middle",flexShrink:0}}><path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>;
  if (n==="search") return <svg width={W} height={H} viewBox={V} fill={F} stroke={c} strokeWidth={SW} strokeLinecap={SL} strokeLinejoin={SL} style={{display:"inline-block",verticalAlign:"middle",flexShrink:0}}><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>;
  if (n==="plus") return <svg width={W} height={H} viewBox={V} fill={F} stroke={c} strokeWidth={SW} strokeLinecap={SL} strokeLinejoin={SL} style={{display:"inline-block",verticalAlign:"middle",flexShrink:0}}><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>;
  if (n==="terms") return <svg width={W} height={H} viewBox={V} fill={F} stroke={c} strokeWidth={SW} strokeLinecap={SL} strokeLinejoin={SL} style={{display:"inline-block",verticalAlign:"middle",flexShrink:0}}><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/></svg>;
  if (n==="external") return <svg width={W} height={H} viewBox={V} fill={F} stroke={c} strokeWidth={SW} strokeLinecap={SL} strokeLinejoin={SL} style={{display:"inline-block",verticalAlign:"middle",flexShrink:0}}><path d="M18 13v6a2 2 0 01-2 2H5a2 2 0 01-2-2V8a2 2 0 012-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>;
  if (n==="eye") return <svg width={W} height={H} viewBox={V} fill={F} stroke={c} strokeWidth={SW} strokeLinecap={SL} strokeLinejoin={SL} style={{display:"inline-block",verticalAlign:"middle",flexShrink:0}}><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>;
  if (n==="up") return <svg width={W} height={H} viewBox={V} fill={F} stroke={c} strokeWidth={SW} strokeLinecap={SL} strokeLinejoin={SL} style={{display:"inline-block",verticalAlign:"middle",flexShrink:0}}><polyline points="18 15 12 9 6 15"/></svg>;
  if (n==="down") return <svg width={W} height={H} viewBox={V} fill={F} stroke={c} strokeWidth={SW} strokeLinecap={SL} strokeLinejoin={SL} style={{display:"inline-block",verticalAlign:"middle",flexShrink:0}}><polyline points="6 9 12 15 18 9"/></svg>;
  if (n==="chevronR") return <svg width={W} height={H} viewBox={V} fill={F} stroke={c} strokeWidth={SW} strokeLinecap={SL} strokeLinejoin={SL} style={{display:"inline-block",verticalAlign:"middle",flexShrink:0}}><polyline points="9 18 15 12 9 6"/></svg>;
  if (n==="whatsapp") return <svg width={W} height={H} viewBox={V} fill={F} stroke={c} strokeWidth={SW} strokeLinecap={SL} strokeLinejoin={SL} style={{display:"inline-block",verticalAlign:"middle",flexShrink:0}}><path d="M21 11.5a8.38 8.38 0 01-.9 3.8 8.5 8.5 0 01-7.6 4.7 8.38 8.38 0 01-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 01-.9-3.8 8.5 8.5 0 014.7-7.6 8.38 8.38 0 013.8-.9h.5a8.48 8.48 0 018 8v.5z"/></svg>;
  return <svg width={W} height={H} viewBox={V} fill={F} stroke={c} strokeWidth={SW} strokeLinecap={SL} strokeLinejoin={SL} style={{display:"inline-block",verticalAlign:"middle",flexShrink:0}}><circle cx="12" cy="12" r="9"/></svg>;
};
    ...
    <div style={{ display:"flex", flexDirection:"column", gap:20 }}>
      ...
      {view === "geography" && (<>
        {indiaRegions.length === 0 && globalRegions.length === 0 ? (
          ...
          {indiaRegions.length > 0 && (<>
            <Card>
              <div style={{ fontFamily:F, fontWeight:700, fontSize:14, color:C.text, marginBottom:16 }}>India Regions — Revenue & Cost</div>
            ...
            <Card>
              <div style={{ fontFamily:F, fontWeight:700, fontSize:14, color:C.text, marginBottom:16 }}>India Region — Profit Contribution</div>
          ...
          {globalRegions.length > 0 && (<>
            <Card>
              <div style={{ fontFamily:F, fontWeight:700, fontSize:14, color:C.text, marginBottom:16 }}>Global Regions — Revenue & Cost</div>
              <div className="bi-2col">
                <div>
                  <div style={{ fontFamily:F, fontSize:12, color:C.muted, marginBottom:10 }}>Revenue Contribution</div>
            ...
            <Card>
              <div style={{ fontFamily:F, fontWeight:700, fontSize:14, color:C.text, marginBottom:16 }}>Global Region — Profit Contribution</div>
      ...
      {view === "department" && (<>
        {deptList.length === 0 ? (
          ...
          <Card>
            <div style={{ fontFamily:F, fontWeight:700, fontSize:14, color:C.text, marginBottom:16 }}>Department — Revenue & Cost</div>
            <div className="bi-2col">
              <div>
          ...
          <Card>
            <div style={{ fontFamily:F, fontWeight:700, fontSize:14, color:C.text, marginBottom:16 }}>Department — Profit Contribution & Budget</div>
